...
در این پروژه، شما باید وظایف هر شخص را در  \lr{Trello} مشخص کرده و پس از انجام آن کار توسط هر شخص، تسک مربوط به آن را به بخش تسک‌های انجام شده منتقل کنید.
...
توجه: با هماهنگی با راهنمای خود، می‌توانید از سرویس‌های مشابه دیگر به جای Trello استفاده نمایید. منظور از سرویس‌های مشابه، سرویس‌هایی با قابلیت‌های مشابه Trello است که به ‌نام \lr{Kanban Board} شناخته می‌شوند و بدیهتا منظور پیام‌رسان‌ها نیست.
...
مثلا اگر تیم $1$ هستید، نام تیم خود را \lr{Team-01} انتخاب کنید. نفرات بعدی گروه شما، باید تیم‌شان را از لیست تیم‌های موجود انتخاب کنند و نیازی به ایجاد تیم ندارند.
