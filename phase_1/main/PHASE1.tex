...
در مستند ضمیمه، به معرفی بازی و قواعد آن مستقل از خواسته‌های پروژه پرداخته شده است.
...
\begin{mybox}[colback=yellow]{پیغام به کاربر}
	\begin{latin}	
		\begin{verbatim}
			...
			<opponent nickname>: <opponent life points>
			C C C 
			DN								
			O	O	H	O	E
			E	DH	DO	OO	E
...
\addcontentsline{toc}{subsection}{{\fehrestContent معرفی کارت‌ها}}
