...
\monster{Gate Guardian}{Resources/monsters/GG.jpg}{Warrior/Effect}{11}{3750}{3400}{
	این هیولا را نمی‌توانید به صورت عادی در زمین قرار دهید اما می‌توانید با ثربامی کردن ۳ هیولای دلخواه در زمین،
...
یکی از هیولاهایی که حریفتان کنترل میکند را مورد هدف قرار دهید و تا انتهای این نوبت از بازی آن را به کنترل خود درآورید.
}
...
تمام  هیولاهای موجود در زمین بازی که از نوع  \lr{Fiend}  و  \lr{Spellcaster}  هستند، 200 واحد ATK/DEF  دریافت میکنند؛ همچنین تمام هیولاهای  از نوع   \lr{Fairy} که در زمین بازی قرار دارند، 200 واحد ATK/Def  از دست می‌دهند.
}
